...
- style_intensity: 中。头七白天的日常里塞进一处躲不开的错位，冲突落在两个老辈人两套说法上

## Chapter Mission
- core_goal: 把异常从自家屋里推到院里，让外人第一次说出这事与她家有关；用邻居的两套说法把「引灵」与「庙里」的分歧摆到台面上，并逼姑姑决定请人
- required_plotlines: L1 主线加压，L4 两套规矩的说法首次在人物嘴上相撞，L5 空间压力由屋扩到院
- required_prior_debts: 第 6 章结尾姑姑说「明儿头七，你站我旁边」必须兑现；第 1 章不能点香的规矩在头七当天须再守一次
...
- title_candidates:
  ...
  - 连夜
- working_title: 猫不进院
- spoiler_risk: 低。标题只给现象，不给来历
- final_title_recheck: 已复核，锁定「猫不进院」。成稿重心在猫的错位与两套说法相撞

## Recall And Return Pressure
- retrieval_slice_targets: 第 6 章「明儿头七，你站我旁边」；第 1 章「等人齐了再点香」；第 5 章院外的炭与墙根
- cold_lines_due: 无
- characters_due_for_return: 谭正阳、谭玉兰、老周、孙姨、二姨、赵老太太
- relationships_due_for_bridge: 谭正阳与谭玉兰；谭家与院外老周家
- foreshadows_due_or_overdue: F023 夜里的叫门声续压；F002 F020 F021 F022 维持已投放
- world_rules_in_play: 头七的流程；碗摆上别点香、等人齐了再说；香炉一直空着

## Conflict
- external_conflict: 院里的猫从奶奶去世那天起就不进院，老周家两口子一个要请符，一个不敢回家
- internal_conflict: 他习惯了把怪事换算成能解释的东西，这一回算式给不出来
...
- active_callbacks: 香炉仍旧空着；长明灯；北后屋冻着的年货
- blocked_reveals: 猫为什么进不了院，本章不答

## Scene Execution
- scene_pressure_shape: 白天的日常收束与院里的错位并行，夜里上门收钩
...
- scene_units:
  ...
  - unit_label: 连夜
    ...
    - turn_or_aftershock: 灯笼的光扫过窗户，两口子走了，院门口的猫还蹲着；姑姑说该请个人来，请的是姓常的
...
- social_or_era_pressure: 老院里谁家有事全院都知道；老周家怕人说，也怕自己不干净
- motif_or_image_return: 香炉、窗、猫、炭棚

## Style Execution
- internalized_strengths: 老宅院子的日常细节扎实，恐惧贴在猫这种最常见的东西上
- active_style_drivers: 日常错位、行为异常、受限视角、两套解释对撞
...
- short_paragraph_license: 两遍看猫、院门口那道线、灯笼的光、章末
- pseudo_style_to_avoid: 把猫写成通灵道具；让姑姑讲解体系；靠形容词堆不祥
- required_effects: 炭棚上掀起的油毡、猫挤在青砖台上、黄猫冲着院里的脑袋、猫脑袋的方向正对朝北的窗、后半夜的敲门与灯笼的光
- optional_effects: 铁桶里烧纸的灰、老周的棉帽子、廊灯
- forbidden_drift: 不得出现鬼、灵将等直白称谓；不得解释猫为什么不进院；不得让姑姑或孙姨讲体系
...
- authenticity_focus: 头七烧纸与老院院子的真实流程，术语零解释
- hook_type: 危机钩加情绪钩
- closure_type: 灯笼的光扫窗，人被逼走，姑姑决定请人
- theme_landing_action: 他顺着猫脑袋的方向，把院门口连到自家朝北的窗上

## Risk Scan
- missing_information: 是谁先看见猫不进院的，本章不细究；孙姨娘家庙在哪儿，只做口语带过
- conflicts_found: 需与第 6 章院外邻居问灯的情节区分开，本章换成老周家两口子
- continuity_risks: 香炉须一直空到人齐；他睡里屋、姑姑睡东屋不变；头七当天不能与第 5、6 章的时间线打架
- forgotten_element_risk: 香炉与长明灯必须在头七当天再露一次
- trope_convenience_risk: 避免把猫写成报信工具；避免老周家变成纯粹的胆小鬼，他们怕得有道理
- user_branch: 无

## Benchmark Check
- benchmark_group: 恐怖悬疑，热度与口碑双高
- hard_gates: 不得出现灵将、鬼等直白称谓，不得出现完整怪物，不得解释体系
- down_weighted_checks: 本章以人物冲突承载恐怖，允许没有生猛声响
- authenticity_risk: 头七流程与老院院子若写假，可信表层会破
...
- plausibility_task: 头七烧纸、老院院子与邻居借车按本地实际做法写；不写只有气势、经不起问的句子
...
## Opening Hook
- opening_hook: 五只猫蹲在院门口，一只也不进来。他提着灰桶绕过去，回头，五只猫脑袋齐刷刷跟着他，转到一半又都转回去，齐齐冲着北屋那扇窗。那扇窗是他家朝北的屋子
