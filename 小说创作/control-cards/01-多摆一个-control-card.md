...
- title_system_reference: 口语短句或反常陈述，取自本章具体物象
- primary_title_job: 聚焦本章压力
- secondary_title_job: 制造悬念
- title_anchor: 谭玉兰那句「多摆一个」
- title_candidates:
  - 多摆一个
  - 给看家的
  - 碗口冲着门
...
- protagonist_personality_trigger: 该说的时候先停一下，看这句话是不是自己要说的；这一章停过之后出来的仍是别人的话，把这个习惯第一次击穿
- character_increment: 他从局外人变成当众赢了一局、却不敢认自己那句话的人
...
- scene_units:
  ...
  - unit_label: 灵棚
    ...
    - turn_or_aftershock: 他转灯罩背风、添油，火苗立起来；棚口老太太因此停脚，认出他是谭家的，回头又看一眼灯
    - carryover: 灯芯是掐的不是剪的，第 2 章回扣；他被排除在操办之外的感受会在卷一反复回压
  - unit_label: 摆碗
    - goal: 投放本章核心
    - conflict: 人齐了，姑姑要多摆一个；多出来的碗端上供桌，又开柜子最上层取出一双旧筷子横在碗上
    - turn_or_aftershock: 他当着姑姑点破这双筷子三年不动一回、爷爷走后下来过一次只摆三天，姑姑的手停了一下，什么也没答
...
## Style Execution
- internalized_strengths: 危险进入快，日常可信度高，结尾余压持续
- active_style_drivers: 日常错位、感官证据、受限视角
- primary_style_payoff: 一处能被感到的不对劲，一次安全解释的失效
- support_style_payoff: 一个能一句话说清的主未知，即碗是给谁的
